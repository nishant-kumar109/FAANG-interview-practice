...
// custom buildSearchArray method for partial search 

// let data = {movie : "p ushpa", searchArr : ['p', 'pu', 'pus', 'push', 'pushpa']}

// findMovie('pus')

// movieList = ['pushpa', 'kgf', 'kabhi khusi kabhi gam', 'avatavar', 'batman']
// pushpa 

// dataArray : ['p', 'pu', 'pus', 'push', 'pushpa']
